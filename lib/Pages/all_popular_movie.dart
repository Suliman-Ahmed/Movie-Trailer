...
class ShowAllPopularMovie extends StatefulWidget {
  AsyncSnapshot<GenreModel> snapshotGenre;
  ShowAllPopularMovie(this.snapshotGenre);
  @override
  _ShowAllPopularMovieState createState() => _ShowAllPopularMovieState();
}

class _ShowAllPopularMovieState extends State<ShowAllPopularMovie> {
  @override
